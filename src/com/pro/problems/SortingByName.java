...
public class SortingByName {
	...
	public static void main(String[] args) {
		...
		list.stream().sorted(Comparator.comparing(Person::getName)).forEach(a -> set.add(a));

//		System.out.println(set);

		Set set1 = new LinkedHashSet();
		list.stream().sorted(Comparator.comparing(Person::getSalary)).forEach(a -> set1.add(a));
